...
export interface InvoiceMainProps extends GenericProps, RouteComponentProps<{id: number}> {
...
@inject('userStore')
@observer
export class InvoiceMainPage extends React.Component<InvoiceMainProps> {
    static defaultProps = {
        invoiceStore,
    };
    ...
    render(): React.ReactNode {
        ...
        return (
            <LazyLoad $={transaction}>
                {() => <InvoiceComponent transaction={transaction} />}
            </LazyLoad>
        );
    }
}
