...
/* form validation */
export interface PartnerPaymentSuccessComponentProps extends GenericProps {
  paymentsStore?: PaymentsStore;
}
export interface PartnerPaymentSuccessComponentState {
}
...
@observer
export class PartnerPaymentSuccessComponent extends React.Component<PartnerPaymentSuccessComponentProps, PartnerPaymentSuccessComponentState> {
  componentWillUnmount(): void {
    this.props.paymentsStore.paymentDone();
  }
  render(): JSX.Element {
    const { t, paymentsStore } = this.props;
    return (
        <div className="modal-body">
            ...
            Successfully charged <em className="charged">${paymentsStore.paymentState.amount}!</em>
            <p>Thank you for your payment. We appreciate your <br />business and look forward to working with you further.</p>

            <Link to="/partner/"><button type="button" className="btn btn-default" data-dismiss="modal">BACK TO DASHBOARD</button></Link>
          </div>
      </div>
    );
  }
